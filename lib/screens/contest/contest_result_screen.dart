...
import '../../widgets/leader_board_contest.dart';
...
class ContestResultScreen extends StatelessWidget {
  ...
  void addUserToLeaderboard(String uid, String contestId, int coins) async {
    print('This is  ContestId: $contestId');
    final leaderboardRef = FirebaseDatabase.instance
        .ref()
        .child('contestInfo')
        .child(contestId)
        .child('leaderboard')
    ...
    if (event.snapshot.value != null) {
      // await leaderboardRef.update({'coins': coins});
    } else {
      // User does not exist, add them to the leaderboard with initial coins
      await leaderboardRef.set({'coins': coins});
    }
  ...
  Widget build(BuildContext context) {
    ...
    addUserToLeaderboard(user!.uid,contestId,coins);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            ContestLeaderBoardCard(contestId:contestId)
          ],
        ),
      ),
    );
