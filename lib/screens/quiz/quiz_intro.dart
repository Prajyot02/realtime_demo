...
class QuizIntroScreen extends StatefulWidget {
  ...
  const QuizIntroScreen({super.key, required this.quizSectionId, required this.description,required this.displayName});
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 10,left: 35,right: 35, bottom: 20),
                  child: Container(
                    height: 350,
      ...
      floatingActionButton:FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => QuizSectionQuizScreen(quizSectionId: quizSectionId)));
